...
public final class PetTypeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpcpetclinic.grpc.PetTypeByIdRequest,
      com.example.grpcpetclinic.grpc.PetTypeResponse> getGetPetTypeByIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPetTypeById",
      requestType = com.example.grpcpetclinic.grpc.PetTypeByIdRequest.class,
      responseType = com.example.grpcpetclinic.grpc.PetTypeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpcpetclinic.grpc.PetTypeByIdRequest,
      com.example.grpcpetclinic.grpc.PetTypeResponse> getGetPetTypeByIdMethod() {
    io.grpc.MethodDescriptor<com.example.grpcpetclinic.grpc.PetTypeByIdRequest, com.example.grpcpetclinic.grpc.PetTypeResponse> getGetPetTypeByIdMethod;
    if ((getGetPetTypeByIdMethod = PetTypeServiceGrpc.getGetPetTypeByIdMethod) == null) {
      synchronized (PetTypeServiceGrpc.class) {
        if ((getGetPetTypeByIdMethod = PetTypeServiceGrpc.getGetPetTypeByIdMethod) == null) {
          PetTypeServiceGrpc.getGetPetTypeByIdMethod = getGetPetTypeByIdMethod =
              io.grpc.MethodDescriptor.<com.example.grpcpetclinic.grpc.PetTypeByIdRequest, com.example.grpcpetclinic.grpc.PetTypeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetPetTypeById"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcpetclinic.grpc.PetTypeByIdRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcpetclinic.grpc.PetTypeResponse.getDefaultInstance()))
              .setSchemaDescriptor(new PetTypeServiceMethodDescriptorSupplier("GetPetTypeById"))
              .build();
        }
      }
    }
    return getGetPetTypeByIdMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getPetTypeById(com.example.grpcpetclinic.grpc.PetTypeByIdRequest request,
        io.grpc.stub.StreamObserver<com.example.grpcpetclinic.grpc.PetTypeResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetPetTypeByIdMethod(), responseObserver);
    }
  }
  ...
  public static final class PetTypeServiceStub
    ...
    /**
     */
    public void getPetTypeById(com.example.grpcpetclinic.grpc.PetTypeByIdRequest request,
        io.grpc.stub.StreamObserver<com.example.grpcpetclinic.grpc.PetTypeResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetPetTypeByIdMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class PetTypeServiceBlockingStub
    ...
    /**
     */
    public com.example.grpcpetclinic.grpc.PetTypeResponse getPetTypeById(com.example.grpcpetclinic.grpc.PetTypeByIdRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetPetTypeByIdMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class PetTypeServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpcpetclinic.grpc.PetTypeResponse> getPetTypeById(
        com.example.grpcpetclinic.grpc.PetTypeByIdRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetPetTypeByIdMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_CREATE_PET_TYPE = 0;
  private static final int METHODID_GET_PET_TYPE_BY_ID = 1;
      ...
      switch (methodId) {
        case METHODID_CREATE_PET_TYPE:
          serviceImpl.createPetType((com.example.grpcpetclinic.grpc.PetTypeRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpcpetclinic.grpc.PetTypeResponse>) responseObserver);
          break;
        case METHODID_GET_PET_TYPE_BY_ID:
          serviceImpl.getPetTypeById((com.example.grpcpetclinic.grpc.PetTypeByIdRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpcpetclinic.grpc.PetTypeResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.grpcpetclinic.grpc.PetTypeByIdRequest,
              com.example.grpcpetclinic.grpc.PetTypeResponse>(
                service, METHODID_GET_PET_TYPE_BY_ID)))
        .build();
  }
      ...
      synchronized (PetTypeServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetPetTypeByIdMethod())
              .build();
        }
      }
    }
